...
def download_landsat_data(coordinates=(85.8245, 20.2961), cloud_cover_lt=10, bands=[2,3,4,8]):
    search = Search(
        bbox=get_tiny_bbox(coordinates),
        query={"eo:cloud_cover": {"lt": cloud_cover_lt}, "collection": {"eq": "landsat-8-l1"}},
    )
