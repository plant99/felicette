...
def process_landsat_vegetation(id, bands):
    ...
    response_show_image = input(
        "Do you want to have a look at the downloaded enhanced image with vegetation ? [Y/n]"
    )
    handle_img_prompt_response(response_show_image,paths,"vegetation_path_jpeg")
...
def process_landsat_rgb(id, bands):
    ...
    response_show_image = input(
        "Do you want to have a look at the downloaded pan enhanced image? [Y/n]"
    )
    handle_img_prompt_response(response_show_image,paths,"output_path_jpeg")
